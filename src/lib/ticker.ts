...
export function tickerDateFactory(
  dates: string[],
...
export function rewindTicker() {
  stopTicker();
  tickerDate.setFirst();
  runRenderFrame();
}

export function loopTicker() {
  tickerDate.setFirst();
  runRenderFrame();
}

export function fastForwardTicker() {
  stopTicker();
  tickerDate.setLast();
  runRenderFrame();
}
...
export function setRunning(flag = true) {
