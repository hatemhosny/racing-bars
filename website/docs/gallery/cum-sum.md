...
A demo showing the use of [`makeCumulative`](/docs/documentation/options.md#makecumulative) option with the [Github Stars dataset](/docs/sample-datasets#github-stars).
